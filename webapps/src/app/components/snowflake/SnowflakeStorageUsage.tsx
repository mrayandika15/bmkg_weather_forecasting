...
export default function SnowflakeStorageChart() {
  const { data, isLoading, isError } = useQuery({
    queryKey: ["snowflake-storage-usage"],
    queryFn: async () => {
      const res = await fetch("/api/snowflake-storage-usage");
  ...
  return (
    <StorageUsageChart
      ...
      description="A comprehensive view of the Snowflake schema's storage usage, showing the distribution of data in the forecasting schema."
